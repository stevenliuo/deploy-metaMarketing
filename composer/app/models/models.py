...
from sqlalchemy import BigInteger, String, DateTime, Integer, LargeBinary
...
class CreatePPTTasks(Base):
    ...
    screenshot_first_slide: Mapped[bytes] = mapped_column(LargeBinary)
...
class CreatePPTTasksSlides(Base):
    ...
    slide_option: Mapped[int] = mapped_column(Integer, nullable=False)
